...
{ /usr/bin/time -v flye --meta --nano-hq ../3_adapter_removal/soft_filter/all.trimmed.highquality.noadapter.fastq --out-dir 2_polishing --iterations 3 --threads 4 --resume ; } 2>> flye_assembly.sh.o3
