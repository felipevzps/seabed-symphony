...
"""
script: plotPie.py
description: plot BGCs per classes and genomes

author: Felipe Vaz Peres
file: https://github.com/felipevzps/seabed-symphony/blob/main/workflow/bin/plotPie.py
version: 1.0
license: MIT

usage:
    python plotPie.py --i run_data.js
"""
...
parser= argparse.ArgumentParser(description='plot BGCs per classes and genomes')
